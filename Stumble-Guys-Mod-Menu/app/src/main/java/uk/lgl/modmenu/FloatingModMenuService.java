...
public class FloatingModMenuService extends Service {
    ...
    int BTN_COLOR = Color.parseColor("#ffe600");
    int MENU_BG_COLOR = Color.parseColor("#ffe600"); //#AARRGGBB
    int MENU_FEATURE_BG_COLOR = Color.parseColor("#ffe600"); //#AARRGGBB
    int MENU_WIDTH = 245;
    int MENU_HEIGHT = 210;
    ...
    int CategoryBG = Color.parseColor("#f78000");
    int CategoryBGColor = Color.parseColor("#9900ff");
    int SeekBarColor = Color.parseColor("#ff4700");
    int CategoryText = Color.parseColor("#000000");
    int SeekBarProgressColor = Color.parseColor("#ff4700");
    int CheckBoxColor = Color.parseColor("#FB3000");
    int RadioColor = Color.parseColor("#000000");
    int RadioClr = Color.parseColor("#ff0000");
    String NumberTxtColor = "#f3f700";

    int CollapseColor = Color.parseColor("#00ff00");

    int BtnON = Color.parseColor("#8d00ff");
    int BtnOFF = Color.parseColor("#ff0000");

    int RichTextViewColor = Color.parseColor("#00f725");
    int TextViewColor = Color.parseColor("#f77c00");
   ...
   */
    ...
    private void initFloating() {
        ...
        Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        ...
        Typeface type1 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        heading.setTypeface(type1);
        ...
        Typeface type2 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        hideBtn.setTypeface(type);
        ...
        Typeface type3 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        closeBtn.setTypeface(type);
    ...
    private View Switch(final int featureNum, final String featureName, boolean switchedOn) {
        ...
        switchR.setTextColor(CategoryText);
        switchR.setBackgroundColor(MENU_BG_COLOR);
        Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        switchR.setTypeface(type);
    ...
    private View SeekBar(final int featureNum, final String featureName, final int min, int max) {
        ...
        linearLayout.setBackgroundColor(MENU_BG_COLOR);

        final TextView textView = new TextView(this);
        textView.setText(Html.fromHtml(featureName + ": <font color='" + CategoryText + "'>" + ((loadedProg == 0) ? min : loadedProg)));
        textView.setTextColor(CategoryText);
        ...
        seekBar.setBackgroundColor(MENU_BG_COLOR);
        ...
        seekBar.setOnSeekBarChangeListener(new SeekBar.OnSeekBarChangeListener() {
            ...
            public void onProgressChanged(SeekBar seekBar, int i, boolean z) {
                ...
                textView.setText(Html.fromHtml(featureName + ": <font color='" + CategoryText + "'>" + (i < min ? min : i)));
                Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                textView.setTypeface(type);
                textView.setBackgroundColor(MENU_BG_COLOR);
            }
    ...
    private View Button(final int featureNum, final String featureName) {
        ...
        Typeface type = Typeface.createFromAsset(getAssets(),"fonts/SONGER_C_Heavy.otf");
    ...
    private View ButtonLink(final String featureName, final String url) {
        ...
        button.setTypeface(type);
        button.setText(Html.fromHtml(featureName));
        button.setBackgroundColor(CategoryBG);
        button.setOnClickListener(new View.OnClickListener() {
            public void onClick(View v) {
    ...
    private View Spinner(final int featureNum, final String featureName, final String list) {
        ...
        GradientDrawable gdSpinnerBody = new GradientDrawable();
        gdSpinnerBody.setStroke(2, Color.parseColor("#000000")); //Set border
        linearLayout2.setBackground(gdSpinnerBody); //Apply GradientDrawable to it
        ...
        spinner.setOnItemSelectedListener(new AdapterView.OnItemSelectedListener() {
            ...
            public void onItemSelected(AdapterView<?> parentView, View selectedItemView, int position, long id) {
                ...
                Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                ((TextView) parentView.getChildAt(0)).setTypeface(type);
            }
    ...
    private View TextField(final int feature, final String featureName, final boolean numOnly) {
        ...
        if (numOnly) {
            ...
            button.setText(Html.fromHtml(featureName + ": <font color='" + RadioColor + "'>" + ((num == 0) ? 1 : num) + "</font>"));
            Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
            button.setTypeface(type);
        } else {
            String string = Preferences.loadPrefString(featureName, feature);
            edittextstring.setString((string == "") ? "" : string);
            button.setText(Html.fromHtml(featureName + ": <font color='" + RadioColor + "'>" + string + "</font>"));
            Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
            button.setTypeface(type);
        }
        ...
        button.setLayoutParams(layoutParams);
        button.setBackgroundColor(BTN_COLOR);
        button.setTextColor(RadioColor);

        GradientDrawable gdButtonBody = new GradientDrawable();
        gdButtonBody.setStroke(2, Color.parseColor("#000000")); //Set border
        button.setBackground(gdButtonBody); //Apply GradientDrawable to it
        ...
        button.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                ...
                TextViewNote.setTextColor(RadioColor);
                Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                TextViewNote.setTypeface(type);
                //Edit text
                final EditText edittext = new EditText(getApplicationContext());
                edittext.setMaxLines(1);
                edittext.setWidth(convertDipToPixels(300));
                edittext.setTextColor(RadioColor);
                edittext.setHintTextColor(HintTxtColor);
                Typeface type1211 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                edittext.setTypeface(type1211);
                if (numOnly) {
                    edittext.setInputType(InputType.TYPE_CLASS_NUMBER);
                    edittext.setKeyListener(DigitsKeyListener.getInstance("0123456789-"));
                    edittext.setText(String.valueOf(edittextnum.getNum()));
                    Typeface type1210 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                    edittext.setTypeface(type1210);
                ...
                Typeface type1219 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
                btndialog.setTypeface(type1219);
    ...
    private View RadioButton(final int featureNum, String featureName, final String list) {
        ...
        for (int i = 0; i < lists.size(); i++) {
            ...
            View.OnClickListener first_radio_listener = new View.OnClickListener() {
                public void onClick(View v) {
                    textView.setText(Html.fromHtml(finalFeatureName + ": <font color='" + RadioClr + "'>" + radioName));
                    Preferences.changeFeatureInt(finalFeatureName, featureNum, radioGroup.indexOfChild(Radioo));
                }
            };
            System.out.println(lists.get(i));
            Radioo.setText(lists.get(i));
            Radioo.setTextColor(RadioClr);
            Typeface type8 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
            Radioo.setTypeface(type);
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.LOLLIPOP)
        ...
        if (index > 0) { //Preventing it to get an index less than 1. below 1 = null = crash
            ...
            Typeface type7 = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
    ...
    private View RichTextView(String text) {
        TextView textView = new TextView(this);
        textView.setBackgroundColor(BTN_COLOR);
        textView.setText(Html.fromHtml(text));
        textView.setTextColor(CategoryText);
        Typeface type = Typeface.createFromAsset(context.getAssets(),"fonts/GarnetCapitals-Bold.ttf");
        textView.setTypeface(type);
    ...
    private void startAnimation() {
        ...
        final int start = Color.parseColor("#FFF50057");
        // final int middle = Color.parseColor("#0000ffff");
        final int end = Color.parseColor("#FFFF3D00");
